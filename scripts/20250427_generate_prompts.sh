...
NAME="20250427_generate_prompts"
...
python ../codes/data_generation/generate_sentence_line.py --output-path "${OUTPUT_PATH}/structure_trees.jsonl" --num-trees $all_count --max-sentences ${max_sentences} --seed 20240427
